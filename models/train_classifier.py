...
def load_data(database_filepath):
    """
    Definition: Loads data from SQL Database
    ...
    # Y['related'] contains three distinct values (0, 1, 2)
    # mapping value 2 to 1
...
def tokenize(text):
    """
    Definition: Normalize, tokenize and lemmatize text data
